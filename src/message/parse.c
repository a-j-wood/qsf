 ...
 */
static void msg_parse__fromhdr(msg_t msg, char *line, long size)
{
	long i, a, b;
	char *ptr;
 ...
 */
static void msg_parse__returnpathhdr(msg_t msg, char *line, long size)
{
	long i, a, b;
	char *ptr;
...
static int msg_parse__header(opts_t opts, msg_t msg)
{
	...
	if ((start == end)
		...
		while ((toupper(msg->original[msg->_pos]) != 'B')
		       && (msg->_pos < end)
 ...
 * of words.
 */
static void msg_parse__trimwhitespace(msg_t msg)
{
